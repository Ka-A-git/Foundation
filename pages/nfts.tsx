...
export default function NFTs(props: PageProps): JSX.Element {
  ...
  const defaultRefinement =
    getFirstValue(searchState?.sortBy) ?? getFirstValue(availableIndexes).value;
  ...
  return (
    <Page title="NFTs" footerCss={{ display: 'none' }}>
      <InstantSearch
