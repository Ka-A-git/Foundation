...
export const useSuggestedTags = <
    ...
    useQuery<SuggestedTags, TError, TData>(
      variables === undefined ? ['SuggestedTags'] : ['SuggestedTags', variables],
      useServerFetcher<SuggestedTags, SuggestedTagsVariables>(SuggestedTagsDocument).bind(null, variables),
      options
    );

useSuggestedTags.getKey = (variables?: SuggestedTagsVariables) => variables === undefined ? ['SuggestedTags'] : ['SuggestedTags', variables];
;
