...
export const useSuggestedTagsCounts = <
    ...
    useQuery<SuggestedTagsCounts, TError, TData>(
      variables === undefined ? ['SuggestedTagsCounts'] : ['SuggestedTagsCounts', variables],
      useServerFetcher<SuggestedTagsCounts, SuggestedTagsCountsVariables>(SuggestedTagsCountsDocument).bind(null, variables),
      options
    );

useSuggestedTagsCounts.getKey = (variables?: SuggestedTagsCountsVariables) => variables === undefined ? ['SuggestedTagsCounts'] : ['SuggestedTagsCounts', variables];
;
