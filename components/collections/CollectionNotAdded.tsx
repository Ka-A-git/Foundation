...
import CollectionAdminTools from './CollectionAdminTools';
...
export default function CollectionNotAdded(
  props: CollectionNotAddedProps
): JSX.Element {
  const { isCurrentUserAdmin, isLoading } = props;
